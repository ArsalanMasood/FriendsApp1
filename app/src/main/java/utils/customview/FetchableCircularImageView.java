 ...
 */
public class FetchableCircularImageView extends ImageView implements ShutterbugManagerListener{
    ...
    public FetchableCircularImageView(final Context context) {
        this(context, null);
    }

    public FetchableCircularImageView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.circularImageViewStyle);
    }

    public FetchableCircularImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public FetchableCircularImageView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void setImage(String url) {
        setImage(url, new ColorDrawable(Color.parseColor("#80000000")));
    }

    public void setImage(String url, int desiredHeight, int desiredWidth) {
        setImage(url, new ColorDrawable(Color.parseColor("#80000000")), desiredHeight, desiredWidth);
    }
